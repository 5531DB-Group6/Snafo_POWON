...
<head>
	...
	<?php if($thispage=="index.php" or $thispage=="group.php" ){?>
	<link rel="stylesheet" type="text/css" href="<?php echo $domain_resource; ?>/css/index.css" />
	<?php } else if($thispage=='list.php' or $thispage=='group_postlist.php' or $thispage == 'group_memberlist.php' or $thispage=='group_pendinglist.php' or $thispage=='group_info.php' or $thispage=='member_home.php'){ ?>
	<link rel="stylesheet" type="text/css" href="<?php echo $domain_resource; ?>/css/list.css" />
	<?php } else if($thispage=='detail.php' or $thispage=='group_post_detail.php'){ ?>
